...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	  
	...
	/* 
	 * UPDATES - TIPO DE ATUALIZAÇÃO: "AMOSTRA"
	 */
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	 ...
	 * QUERIES CONSTANTES PARA MANIPULAÇÃO DA DB
	 */    
      private final String UPDATE_AMOSTRAS = "UPDATE amostra SET abebida=?, avariedade=?, atulhadestino=?, arenda=? WHERE lote_lnome LIKE ?";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  		...
  		//UPDATE
      	public void update(String aBebida, String aVariedade, String aTulhaDestino, String aRenda, String lote_lNome) {
		
		  	try {
		  		connection = AcessoDB.conectar();
		  		preparedStatement = connection.prepareStatement(UPDATE_AMOSTRAS);
		  		preparedStatement.setString(1, aBebida);
		  		preparedStatement.setString(2, aVariedade);
		  		preparedStatement.setString(3, aTulhaDestino);
		  		preparedStatement.setString(4, aRenda);
		  		preparedStatement.setString(5, lote_lNome);
		  		preparedStatement.executeUpdate();
